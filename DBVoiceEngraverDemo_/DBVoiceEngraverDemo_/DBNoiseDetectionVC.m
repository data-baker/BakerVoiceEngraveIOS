...
#import <DBVoiceEngraver/DBVoiceDetectionUtil.h>
...
- (IBAction)startEngraverAction:(id)sender {
    ...
    [self.voiceEngraverManager getRecordTextArrayTextHandler:^(NSArray * _Nonnull textArray) {
        ...
        [self.view makeToast:@"获取录音文本失败" duration:2 position:CSToastPositionCenter];
    }];
}
...
- (IBAction)voiceDetectcomeBack:(UIStoryboardSegue *)segue {
